...
def test_prepare_output_directory_creates_directory(tmp_path, monkeypatch):
...
def test_prepare_output_directory_recreates_existing_directory(tmp_path, monkeypatch):
    output_dir = tmp_path / "netex" / "output"
    output_dir.mkdir()
