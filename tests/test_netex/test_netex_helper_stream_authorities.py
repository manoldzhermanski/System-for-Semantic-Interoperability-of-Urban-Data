...
def test_netex_helper_stream_authorities_writes_all_authorities():
    """
    ...
    netex_utils.netex_helper_stream_authorities(xml_file, agencies)

    assert xml_file.write.call_count == 2
    
def test_netex_helper_stream_authorities_skips_invalid_entities():
    """
...
def test_netex_helper_stream_authorities_skips_duplicate_authorities():
    """
    ...
    netex_utils.netex_helper_stream_authorities(xml_file, entities)

    assert xml_file.write.call_count == 1
    
def test_netex_helper_stream_authorities_with_empty_input():
    """
    ...
    netex_utils.netex_helper_stream_authorities(xml_file, [])
