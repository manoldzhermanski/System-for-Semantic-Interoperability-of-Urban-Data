...
from netex.netex_utils import netex_stream_service_calendar_frame_for_shared_data_xml
...
def test_service_calendar_frame_structure():
    ...
    with etree.xmlfile(xml_output, encoding="utf-8") as xf:
        netex_stream_service_calendar_frame_for_shared_data_xml(xf, calendars, calendar_dates)
...
def test_stream_calls_day_types(monkeypatch):
    ...
    netex_stream_service_calendar_frame_for_shared_data_xml(xml_file, calendars, calendar_dates)
