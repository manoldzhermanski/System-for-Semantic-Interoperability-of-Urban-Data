...
def test_netex_get_all_gtfs_agencies_of_a_city_success():
...
def test_netex_get_all_gtfs_agencies_of_a_city_without_city():

    config.NETEX_OPERATING_CITY = None

    with pytest.raises(ValueError):
        netex_utils.netex_get_all_gtfs_agencies_of_a_city()