...
@patch("gtfs_static.gtfs_static_utils.convert_gtfs_trips_to_ngsi_ld")
@patch("gtfs_static.gtfs_static_utils.validate_gtfs_trips_entity")
@patch("gtfs_static.gtfs_static_utils.parse_gtfs_trips_data")
def test_gtfs_static_trips_to_ngsi_ld(mock_parse, mock_validate, mock_convert, mock_remove_none):
    """
