...
@patch("gtfs_static.gtfs_static_utils.convert_gtfs_shapes_to_ngsi_ld")
@patch("gtfs_static.gtfs_static_utils.validate_gtfs_shapes_entity")
@patch("gtfs_static.gtfs_static_utils.parse_gtfs_shapes_data")
