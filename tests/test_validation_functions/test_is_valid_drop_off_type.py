...
def test_is_valid_drop_off_type_valid_strings():
...
def test_is_valid_drop_off_type_invalid_strings():
    assert is_valid_drop_off_type("-1") is False
    assert is_valid_drop_off_type("4") is False
    assert is_valid_drop_off_type("") is False
    assert is_valid_drop_off_type(" ") is False
    assert is_valid_drop_off_type("abc") is False
    assert is_valid_drop_off_type("-") is False
    assert is_valid_drop_off_type("1.5") is False

def test_is_valid_drop_off_type_invalid_types():
    assert is_valid_drop_off_type(None) is False
    assert is_valid_drop_off_type(2) is False
