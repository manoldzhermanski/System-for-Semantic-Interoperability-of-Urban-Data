...
def test_is_valid_continuous_pickup_valid_strings():
...
def test_is_valid_continuous_pickup_invalid_strings():
    assert is_valid_continuous_pickup("-1") is False
    assert is_valid_continuous_pickup("4") is False
    assert is_valid_continuous_pickup("") is False
    assert is_valid_continuous_pickup(" ") is False
    assert is_valid_continuous_pickup("abc") is False
    assert is_valid_continuous_pickup("-") is False
    assert is_valid_continuous_pickup("1.5") is False

def test_is_valid_continuous_pickup_invalid_types():
    assert is_valid_continuous_pickup(None) is False
    assert is_valid_continuous_pickup(2) is False
