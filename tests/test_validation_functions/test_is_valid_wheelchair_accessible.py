...
def test_is_valid_wheelchair_accessible_valid_values():
    ...
    assert is_valid_wheelchair_accessible("") is True

def test_is_valid_wheelchair_accessible_invalid_values():
...
def test_is_valid_wheelchair_accessible_invalid_types():
    ...
    assert is_valid_wheelchair_accessible("0") is False
