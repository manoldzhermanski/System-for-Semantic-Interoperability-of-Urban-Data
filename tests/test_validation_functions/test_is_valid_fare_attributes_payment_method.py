...
def test_is_valid_fare_attributes_payment_method_valid_strings():
    assert is_valid_fare_attributes_payment_method("0") is True
    assert is_valid_fare_attributes_payment_method("1") is True

def test_is_valid_fare_attributes_payment_method_invalid_strings():
...
def test_is_valid_fare_attributes_payment_method_invalid_types():
