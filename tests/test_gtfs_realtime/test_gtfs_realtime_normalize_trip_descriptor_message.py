...
def test_normalize_trip_full_payload():
    ...
    expected = {
        "trip_id": f"urn:ngsi-ld:GtfsTrip:{config.get_operating_city()}:123",
        "route_id": f"urn:ngsi-ld:GtfsRoute:{config.get_operating_city()}:10",
        "direction_id": "1",
        "start_time": "08:00:00",
        "start_date": "20240101",
        "schedule_relationship": "SCHEDULED",
        "modified_trip": {
            "modifications_id": "mod-1",
            "affected_trip_id": f"urn:ngsi-ld:GtfsTrip:{config.get_operating_city()}:trip-456",
            "start_time": "08:10:00",
            "start_date": "20240102",
        },
    }
