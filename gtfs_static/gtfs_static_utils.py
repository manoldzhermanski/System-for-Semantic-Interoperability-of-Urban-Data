...
def parse_gtfs_stop_times_data(entity: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "arrival_time": parse_gtfs_time(entity.get("arrival_time")),
        "departure_time": parse_gtfs_time(entity.get("departure_time")),
        ...
        "start_pickup_drop_off_window": parse_gtfs_time(entity.get("start_pickup_drop_off_window")),
        "end_pickup_drop_off_window": parse_gtfs_time(entity.get("end_pickup_drop_off_window")),
